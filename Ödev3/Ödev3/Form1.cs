...
namespace Ödev3
{
    public partial class Form1 : Form
    {
        ...
        private void testBtn_Click(object sender, EventArgs e)
        {
            ...
            BitmisGorusme bitmisGorusme3 = new BitmisGorusme(gorusme3, "Üzerime iki kere tıkla. ");
            lvBitmisGorusme.Items.Add(bitmisGorusme3.BilgileriAl());
            BitmisGorusmeLl.InsertLast(bitmisGorusme3);

            Arama arama4 = new Arama(++AramaCount, "Ticari");
            Gorusme gorusme4 = new Gorusme(arama4, TemsilciLl.First().Next.Next.Value);
            BitmisGorusme bitmisGorusme4 = new BitmisGorusme(gorusme4, "Müşterinin talepleri yerine getirildi.");
            lvBitmisGorusme.Items.Add(bitmisGorusme4.BilgileriAl());
            BitmisGorusmeLl.InsertLast(bitmisGorusme4);

            Arama arama5 = new Arama(++AramaCount, "Bireysel");
            Gorusme gorusme5 = new Gorusme(arama5, TemsilciLl.First().Value);
            BitmisGorusme bitmisGorusme5 = new BitmisGorusme(gorusme5, "Müşterinin:telefonu:kapandı.");
            lvBitmisGorusme.Items.Add(bitmisGorusme5.BilgileriAl());
            BitmisGorusmeLl.InsertLast(bitmisGorusme5);
        }
